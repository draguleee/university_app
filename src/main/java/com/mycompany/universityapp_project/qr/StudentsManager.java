...
public class StudentsManager implements IEntityManager {
    ...
    private String folderPath = "C:\\Users\\aandr\\source\\repos\\ssatr_lab\\laboratoare-ssatr-ia-2023-draguleee\\universityapp_project\\qr\\students\\";
    ...
    public void generateQrCode(Object object, Runnable afterGeneration) {
        new Thread(() -> {
            ...
            try {
                ...
                filePath = folderPath + "student_" + ((Student)object).getStudentId() + ".png";
    ...
    public void deleteQrCode(String fileName) {
        filePath = folderPath + "student_" + fileName + ".png";
